...
import (
	...
	scheme "github.com/alice02/crd-controller-sample/pkg/client/clientset/versioned/scheme"
...
type SampleResourceInterface interface {
	...
	UpdateStatus(*v1.SampleResource) (*v1.SampleResource, error)
...
func (c *sampleResources) UpdateStatus(sampleResource *v1.SampleResource) (result *v1.SampleResource, err error) {
	result = &v1.SampleResource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sampleresources").
