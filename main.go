...
func main() {
	...
	//kubeInformarFactory := kubeinformers.NewSharedInformerFactory(kubeClient, time.Second*30)
	exampleInformerFactory := informers.NewSharedInformerFactory(exampleClient, time.Second*30)

	controller := NewController(kubeClient, exampleClient, exampleInformerFactory.Example().V1().SampleResources())

	//	kubeInformarFactory.Start(stopCh)
